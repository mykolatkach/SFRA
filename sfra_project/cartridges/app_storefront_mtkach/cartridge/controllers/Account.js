 ...
 * @param {httpparameter} - dwfrm_profile_customer_hobby - Option field for the customer's hobby
...
server.append(
    ...
    function (req, res, next) {
        ...
        viewData.profileForm.customer.hobby.value = customer.getProfile().custom.hobby;
